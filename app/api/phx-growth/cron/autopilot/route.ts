// ─── PHX GROWTH · CRON · AUTOPILOT ──────────────────────────────────────────
// GET /api/phx-growth/cron/autopilot
...
import { ok, fail, log, requestId } from '@/phx-growth/api';
import { authorizeCron, runAutopilotSweep } from '@/phx-growth/cron';
