// ─── PHX GROWTH · HUBSPOT OAUTH CALLBACK ────────────────────────────────────
// GET /api/phx-growth/connectors/hubspot/callback?code=…&state=…
...
import { exchangeCodeForTokens } from '@/phx-growth/hubspot';
...
export async function GET(req: NextRequest) {
  ...
  const redirectUri = `${origin}/api/phx-growth/connectors/hubspot/callback`;
  ...
  try {
    ...
    console.error('[phx-growth] hubspot callback failed:', err);
