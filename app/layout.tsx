...
const TITLE = 'PHX Growth — the autonomous media buyer that lands on profit';
const DESCRIPTION =
  'AI media buying is table stakes. PHX Growth flies Meta, Google & TikTok to real profit — steering by your Shopify and QuickBooks ground truth, not platform-reported ROAS. Creative pre-tested before a dollar of spend. 24/7, hands off the wheel.';
