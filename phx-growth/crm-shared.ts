// ─── PHX GROWTH · CRM SHARED (client-safe) ──────────────────────────────────
...
export const PIPELINE: PipelineStage[] = [
  ...
  { id: 'inflight', label: 'In-Flight', description: 'Live — PHX Growth is flying their spend', hue: '#FF2E9A', weight: 36 },
...
export interface CrmClient {
  ...
  monthlySpend?: number;
  /** What the client pays PHX Growth monthly (USD). */
  retainer?: number;
  stage: StageId;
  source: ClientSource;
...
// The over-the-wire shape of /api/phx-growth/crm/integrations entries.
