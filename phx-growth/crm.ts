// ─── PHX GROWTH · ORBITAL CRM ───────────────────────────────────────────────
// The client command core. Every client PHX Growth flies for is a CrmClient —
...
// Everything a client's business might run on, mapped to how PHX Growth
...
export interface IntegrationDef {
  ...
  /** What PHX Growth does with this pipe once a client attaches it. */
...
const OAUTH_INTEGRATIONS: IntegrationDef[] = Object.values(CONNECTORS).map((c) => ({
  ...
  powers: c.powers[0],
  wiredVia: `/api/phx-growth/connectors/${c.id}`,
}));
...
const ENGINE_INTEGRATIONS: IntegrationDef[] = [
  {
    ...
    wiredVia: 'phx-growth/hubspot · /api/phx-growth/connectors/hubspot',
  },
  {
    id: 'quickbooks',
    name: 'QuickBooks',
    ...
    wiredVia: 'phx-growth/quickbooks · /api/phx-growth/connectors/quickbooks',
  },
  {
    id: 'higgsfield',
    name: 'Higgsfield',
    ...
    wiredVia: 'phx-growth/higgsfield · /api/phx-growth/higgsfield',
  },
  {
    id: 'n8n',
    name: 'n8n Spine',
    ...
    wiredVia: 'phx-growth/executor · n8n/*.json',
  },
  {
    id: 'zapier',
    name: 'Zapier Relay',
    ...
    wiredVia: 'phx-growth/executor · /api/phx-growth/zapier',
  },
];
