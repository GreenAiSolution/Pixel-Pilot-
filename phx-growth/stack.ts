...
// PHX Growth flies with, grouped by business function. Each tool declares HOW it
...
// API (/api/phx-growth/stack) reports live status. Keeping it here means the
// catalog is the single source of truth for "what PHX Growth can plug into."
...
export interface StackTool {
  ...
  /** One line: what it does for PHX Growth. */
...
export const STACK_CATEGORIES: readonly CategoryMeta[] = [
  { id: 'Advertising', summary: 'The channels PHX Growth flies to profit.', hue: '#00D4FF' },
...
export const STACK: readonly StackTool[] = [
  ...
  // ── Creative & Content ─────────────────────────────────────────────────────
  { id: 'higgsfield', name: 'Creative Forge', category: 'Creative & Content', blurb: 'PHX Growth’s render engine — ad stills, reels & video.', via: 'native', hue: '#FF4F9A', connected: true },
