// ─── PHX GROWTH · AUTOPILOT HEARTBEAT ───────────────────────────────────────
...
//
//   /api/phx-growth/cron/autopilot  → every 15 min · optimization sweep
//   /api/phx-growth/cron/nurture    → hourly       · lead re-engagement sweep
//
