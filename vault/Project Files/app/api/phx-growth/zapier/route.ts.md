...
file: app/api/phx-growth/zapier/route.ts
---

# `app/api/phx-growth/zapier/route.ts`

Part of [[📁 Codebase]] — live copy at `~/PHX-Growth/app/api/phx-growth/zapier/route.ts`

````ts
// ─── PHX GROWTH · ZAPIER TRIGGER ────────────────────────────────────────────
// POST /api/phx-growth/zapier
