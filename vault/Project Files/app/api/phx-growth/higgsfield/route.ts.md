...
file: app/api/phx-growth/higgsfield/route.ts
---

# `app/api/phx-growth/higgsfield/route.ts`

Part of [[📁 Codebase]] — live copy at `~/PHX-Growth/app/api/phx-growth/higgsfield/route.ts`

**Imports** [[Project Files/phx-growth/index.ts|index.ts]]

````ts
// ─── PHX GROWTH · HIGGSFIELD CREATIVE FORGE ─────────────────────────────────
// POST /api/phx-growth/higgsfield
