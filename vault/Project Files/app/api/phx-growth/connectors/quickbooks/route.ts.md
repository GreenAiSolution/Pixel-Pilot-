...
file: app/api/phx-growth/connectors/quickbooks/route.ts
---

# `app/api/phx-growth/connectors/quickbooks/route.ts`

Part of [[📁 Codebase]] — live copy at `~/PHX-Growth/app/api/phx-growth/connectors/quickbooks/route.ts`

**Imports** [[Project Files/phx-growth/quickbooks.ts|quickbooks.ts]]

````ts
// ─── PHX GROWTH · QUICKBOOKS OAUTH START ────────────────────────────────────
// GET /api/phx-growth/connectors/quickbooks
...
import { buildAuthUrl, quickbooksConfigured, redirectUri } from '@/phx-growth/quickbooks';
