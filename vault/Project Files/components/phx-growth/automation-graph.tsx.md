...
file: components/phx-growth/automation-graph.tsx
---

# `components/phx-growth/automation-graph.tsx`

Part of [[📁 Codebase]] — live copy at `~/PHX-Growth/components/phx-growth/automation-graph.tsx`
...
// ─── PHX GROWTH · LIVE AUTOMATION GRAPH ─────────────────────────────────────
...
import type { AutoGraph, AutoNode, NodeKind } from "@/phx-growth";
