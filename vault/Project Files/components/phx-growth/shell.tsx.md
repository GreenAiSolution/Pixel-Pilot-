...
file: components/phx-growth/shell.tsx
---

# `components/phx-growth/shell.tsx`

Part of [[📁 Codebase]] — live copy at `~/PHX-Growth/components/phx-growth/shell.tsx`

**Imports** [[Project Files/components/phx-growth/flight-scene.tsx|flight-scene.tsx]]
...
const FlightScene = dynamic(
  () => import("@/components/phx-growth/flight-scene").then((m) => ({ default: m.FlightScene })),
  { ssr: false }
);
