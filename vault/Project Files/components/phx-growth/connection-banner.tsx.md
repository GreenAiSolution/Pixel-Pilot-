...
file: components/phx-growth/connection-banner.tsx
---

# `components/phx-growth/connection-banner.tsx`

Part of [[📁 Codebase]] — live copy at `~/PHX-Growth/components/phx-growth/connection-banner.tsx`
...
import { CONNECTORS, isConnectorId } from "@/phx-growth";
...
export function ConnectionBanner() {
  ...
  useEffect(() => {
    ...
    if (ok) {
      setMsg({ kind: "ok", text: `${name} connected. PHX Growth has the controls.` });
    } else {
