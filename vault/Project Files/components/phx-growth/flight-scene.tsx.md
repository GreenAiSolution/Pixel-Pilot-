...
file: components/phx-growth/flight-scene.tsx
---

# `components/phx-growth/flight-scene.tsx`

Part of [[📁 Codebase]] — live copy at `~/PHX-Growth/components/phx-growth/flight-scene.tsx`

**Imports** [[Project Files/phx-growth/connectors.ts|connectors.ts]]
...
import { CONNECTOR_LIST } from "@/phx-growth/connectors";
