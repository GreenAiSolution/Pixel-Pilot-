...
file: components/phx-growth/sections.tsx
---

# `components/phx-growth/sections.tsx`

Part of [[📁 Codebase]] — live copy at `~/PHX-Growth/components/phx-growth/sections.tsx`

**Imports** [[Project Files/components/phx-growth/creative-forge.tsx|creative-forge.tsx]] · [[Project Files/phx-growth/index.ts|index.ts]]

````tsx
"use client";

// ─── PHX GROWTH · MARKETING SECTIONS ────────────────────────────────────────
...
import { CreativeForge } from "@/components/phx-growth/creative-forge";
...
function ConnectorCard({ c }: { c: Connector }) {
  ...
  async function connect() {
    setStatus("checking");
    try {
      const res = await fetch(`/api/phx-growth/connectors/${c.id}`, { redirect: "manual" });
      if (res.type === "opaqueredirect" || (res.status >= 300 && res.status < 400)) {
        window.location.href = `/api/phx-growth/connectors/${c.id}`;
        return;
      }
    ...
    <section className="min-h-screen flex flex-col justify-center px-6 py-24">
      <div className="container mx-auto max-w-5xl text-center flex flex-col items-center gap-8">
        ...
        <p className="text-lg md:text-xl text-text-secondary max-w-2xl leading-relaxed">
          PHX Growth isn&apos;t a dashboard. It&apos;s an autonomous media buyer that flies Meta, Google &amp; TikTok to{" "}
    ...
    <section className="px-6 py-24">
      <div className="container mx-auto max-w-6xl">
        <Reveal className="text-center max-w-3xl mx-auto space-y-4 mb-14">
          ...
          <p className="text-text-secondary text-lg">Everything PHX Growth flies, organized. Pick a runway.</p>
        </Reveal>
      ...
      <section id="film" className="px-6 py-24">
        <div className="container mx-auto max-w-5xl">
          <Reveal className="text-center max-w-2xl mx-auto space-y-4 mb-10">
            ...
            <p className="text-text-secondary text-lg">One pass from PHX Growth turns a struggling shop into a landmark — and the customers come running.</p>
          </Reveal>
          <Reveal>
          ...
          <Reveal className="grid lg:grid-cols-[0.85fr_1.15fr] gap-12 items-start">
            <div className="lg:sticky lg:top-28 space-y-4">
              ...
              <p className="text-text-secondary text-lg max-w-md">
                PHX Growth is not one giant prompt. It is a crew of specialized agents that plan, buy, forge creative, check profit, guard policy, wire automations and watch the flight deck.
              </p>
        ...
        <div className="container mx-auto max-w-6xl">
          <Reveal className="grid lg:grid-cols-[1fr_1.4fr] gap-12 items-start">
            <div className="lg:sticky lg:top-28 space-y-4">
              ...
              <p className="text-text-secondary text-lg max-w-md">
                PHX Growth flies where your money already lives. OAuth in a click — spend and delivery flow in, decisions flow back out, and Shopify keeps everyone honest with real profit.
              </p>
        ...
        <div className="container mx-auto max-w-6xl">
          <Reveal className="text-center max-w-3xl mx-auto space-y-4 mb-12">
            ...
            <p className="text-text-secondary text-lg">
              This is the product automating itself, live. Drop a brand, pick a vibe, and PHX Growth fires Higgsfield to forge a scroll-stopping reel — the same engine that refreshes fatigued creative on your account automatically.
            </p>
          </Reveal>
          <Reveal className="mb-12">
            <div className="relative mx-auto max-w-4xl aspect-video overflow-hidden rounded-2xl border border-white/10">
              <video src={PHX_GROWTH_REEL} autoPlay loop muted playsInline className="h-full w-full object-cover" />
      ...
      <section id="automation" className="px-6 py-24">
        <div className="container mx-auto max-w-6xl">
          <Reveal className="text-center max-w-3xl mx-auto space-y-4 mb-12">
            ...
            <p className="text-text-secondary text-lg">Every decision PHX Growth makes rides a real n8n workflow — importable, auditable, yours. Here are four of the brains on the wing.</p>
          </Reveal>
      ...
      <section id="flight-plan" className="px-6 py-24">
        <div className="container mx-auto max-w-5xl">
          <Reveal className="text-center max-w-3xl mx-auto space-y-4 mb-14">
            ...
            <p className="text-text-secondary text-lg">The launch agencies take three weeks to fly. Paste a product URL, walk away — PHX Growth runs the whole flight plan hands-off, and pings you when it&apos;s airborne.</p>
          </Reveal>
      ...
      <section id="results" className="px-6 py-24">
        <div className="container mx-auto max-w-6xl">
          <Reveal className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <p className="text-text-secondary text-lg">
              The only question that matters: is this making you money? Here&apos;s exactly how PHX Growth brings in more
