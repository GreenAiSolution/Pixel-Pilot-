...
file: phx-growth/automations.ts
---

# `phx-growth/automations.ts`

Part of [[📁 Codebase]] — live copy at `~/PHX-Growth/phx-growth/automations.ts`

**Imports** [[Project Files/phx-growth/connectors.ts|connectors.ts]] · [[Project Files/phx-growth/services.ts|services.ts]] · [[Project Files/phx-growth/workflows.ts|workflows.ts]]

````ts
// ─── PHX GROWTH · AUTOMATION DESIGNER ───────────────────────────────────────
