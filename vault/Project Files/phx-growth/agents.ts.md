...
file: phx-growth/agents.ts
---

# `phx-growth/agents.ts`

Part of [[📁 Codebase]] — live copy at `~/PHX-Growth/phx-growth/agents.ts`

````ts
// ─── PHX GROWTH · AUTONOMOUS AGENTS ─────────────────────────────────────────
...
// and has explicit guardrails so PHX Growth can act without becoming reckless.
