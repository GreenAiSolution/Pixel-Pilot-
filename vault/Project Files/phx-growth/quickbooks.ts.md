...
file: phx-growth/quickbooks.ts
---

# `phx-growth/quickbooks.ts`

Part of [[📁 Codebase]] — live copy at `~/PHX-Growth/phx-growth/quickbooks.ts`

**Imports** [[Project Files/phx-growth/store.ts|store.ts]]

````ts
// ─── PHX GROWTH · QUICKBOOKS ONLINE (native) ────────────────────────────────
// A first-class QuickBooks Online integration — no Zapier in the path. Set Intuit
// app credentials, click "Connect QuickBooks" once (OAuth2), and PHX Growth can
...
//   QUICKBOOKS_REDIRECT_URI  (…/api/phx-growth/connectors/quickbooks/callback)
