...
file: phx-growth/ai.ts
---

# `phx-growth/ai.ts`

Part of [[📁 Codebase]] — live copy at `~/PHX-Growth/phx-growth/ai.ts`

````ts
// ─── PHX GROWTH · AI ENGINE ─────────────────────────────────────────────────
...
const TOOL_SYSTEM =
  'PHX Growth tool standard: return finished, usable work; be specific to the submitted business; avoid unsupported guarantees; include operational next steps; and keep outputs safe for paid-media/account use.';
