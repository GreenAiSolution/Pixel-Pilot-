...
file: phx-growth/tools.ts
---

# `phx-growth/tools.ts`

Part of [[📁 Codebase]] — live copy at `~/PHX-Growth/phx-growth/tools.ts`

````ts
// ─── PHX GROWTH · TOOL SYSTEM ───────────────────────────────────────────────
...
export const STUDIO_TOOLS: readonly StudioToolDefinition[] = [
  {
    ...
    category: 'Strategy',
    endpoint: '/api/phx-growth/tools/launch-plan',
    accent: '#00D4FF',
    icon: '◎',
  ...
  },
  {
    ...
    category: 'Strategy',
    endpoint: '/api/phx-growth/tools/brand',
    accent: '#C9A84C',
    icon: '❖',
  ...
  },
  {
    ...
    category: 'Strategy',
    endpoint: '/api/phx-growth/tools/funnel',
    accent: '#6C63FF',
    icon: '⧉',
  ...
  },
  {
    ...
    category: 'Build',
    endpoint: '/api/phx-growth/tools/website',
    accent: '#00D4FF',
    icon: '▤',
  ...
  },
  {
    ...
    name: 'Premium AI Ads',
    category: 'Build',
    endpoint: '/api/phx-growth/tools/ads',
    accent: '#FF2E9A',
    icon: '✦',
  ...
  },
  {
    ...
    name: 'Content Engine',
    category: 'Build',
    endpoint: '/api/phx-growth/tools/content',
    accent: '#FF2E9A',
    icon: '◈',
  ...
  },
  {
    ...
    category: 'Optimize',
    endpoint: '/api/phx-growth/tools/pretest',
    accent: '#C9A84C',
    icon: '◉',
  ...
  },
  {
    ...
    name: 'AI Employees',
    category: 'Optimize',
    endpoint: '/api/phx-growth/tools/employees',
    accent: '#6C63FF',
    icon: '❈',
