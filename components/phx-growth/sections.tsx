          ...
          <Reveal className="grid lg:grid-cols-[0.85fr_1.15fr] gap-12 items-start">
            <div className="lg:sticky lg:top-28 space-y-4">
              ...
              <p className="text-text-secondary text-lg max-w-md">
                PHX Growth isn&apos;t one giant prompt. It&apos;s a crew of specialist agents that plan, buy, forge creative, check profit against your books, close sales, rank you first, win five-star reviews, guard policy and run the flight deck — around the clock.
              </p>
        ...
        <div className="container mx-auto max-w-6xl">
          <Reveal className="text-center max-w-3xl mx-auto space-y-4 mb-12">
            ...
            <p className="text-text-secondary text-lg">
              This is the product automating itself, live. Drop a brand, pick a vibe, and PHX Growth forges a scroll-stopping reel — the same engine that catches creative fatigue on your account and ships the refresh before performance dips.
            </p>
          </Reveal>
            ...
            <div className="relative mx-auto max-w-4xl aspect-video overflow-hidden rounded-2xl border border-white/10">
              ...
              <div className="pointer-events-none absolute inset-x-0 bottom-0 p-6 text-center">
                <div className="text-2xl font-semibold tracking-[0.18em] uppercase bg-clip-text text-transparent inline-block" style={{ backgroundImage: GRADIENT }}>
                  PHX<span className="text-white">&nbsp;Growth</span>
                </div>
                ...
                return (
                  <figure key={v.id} className="group relative rounded-2xl border border-white/10 bg-black/40 overflow-hidden aspect-[9/16]">
                    {shot.videoUrl ? (
                      ...
                      <img src={shot.posterUrl} alt={`${v.name} ad forged by PHX Growth`} className="h-full w-full object-cover transition duration-500 group-hover:scale-[1.04]" />
                    )}
      ...
      <section id="automation" className="px-6 py-24">
        <div className="container mx-auto max-w-6xl">
          <Reveal className="text-center max-w-3xl mx-auto space-y-4 mb-12">
            ...
            <p className="text-text-secondary text-lg">Every decision PHX Growth makes rides a real n8n workflow — importable, auditable, yours. These are the brains on the wing.</p>
          </Reveal>
    ...
    <section className="px-6 py-24">
      <div className="container mx-auto max-w-6xl">
        <Reveal className="text-center max-w-3xl mx-auto space-y-4 mb-14">
          ...
          <p className="text-text-secondary text-lg">
            PHX Growth isn&apos;t here to make dashboards pretty. It exists to grow one number — the count of
