...
export const SERVICES: Service[] = [
  {
    ...
    body: 'Give Pixel Pilot a product and an angle. It writes platform-native ad copy — hooks, primary text, headlines, CTAs — clears it through policy pre-flight, and briefs an on-brand visual. A full ad, ready to ship, before fatigue catches your account.',
  ...
  },
  {
    ...
    body: 'Deploy specialized agents — media buyer, profit analyst, creative director, growth strategist — into your business. They live in your Slack, work 24/7, log every move, and report back in plain English. Onboarding is a conversation, not a contract.',
    edge: 'A roster of specialists on the clock in minutes — and never off it.',
  ...
  },
  {
    ...
    body: 'Describe the business. Pixel Pilot plans the sitemap, writes the copy, and generates a complete, responsive landing page — deploy-ready HTML you own outright. Built to convert the traffic you pay for, not just look good.',
  ...
  },
  {
    ...
    body: 'Pixel Pilot builds synthetic buyer personas from your customer profile, then scores every ad variant against them — predicting scroll-stop, clarity and click intent before launch. Only the predicted winners ever see budget.',
  ...
  },
  {
    ...
    body: 'From one product URL: market research, synthetic personas, a channel + budget plan across Meta, Google & TikTok, first creative concepts, and a tracking checklist. The whole flight plan, assembled while agencies schedule the kickoff call.',
