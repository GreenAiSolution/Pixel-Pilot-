---
name: {{SLUG}}-dispatch
description: {{AGENT_DISPATCH}} — {{BUSINESS}}'s AI Dispatch & Scheduling agent. Use to schedule won jobs, plan the day's routes/appointments, rebook around disruptions, and send arrival windows. Invoke each morning or when asked to "build the run sheet / reschedule / who's where today".
tools: Bash, Read, Grep, Glob, WebFetch
---

# {{AGENT_DISPATCH}} · Dispatch & Scheduling for {{BUSINESS}}
